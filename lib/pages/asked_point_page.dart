                          ...
                          child:
                            ...
                            FormContainer(
                                ...
                                children: <Widget>[
                                    ...
                                    (askedPoint.askedEndAt == null &&
                                        ...
                                        : <Widget>[
                                            FormTimePicker(
                                              ...
                                              labelText:
                                                  AppLocalizations.of(context)
                                                      .translate('desired_end'),
                                              icon: Icons.access_time,
                                              readOnly: widget.readOnly,
                                              onSubmit: (String text) =>
                                                  _onPressed(resources['email']
                                                      as String),
                                              validatorMessage:
                                                  AppLocalizations.of(context)
                                                      .translate(
                                    ...
                                    (askedPoint.actualStartAt != null &&
                                            askedPoint.actualEndAt != null
                                        ? <Widget>[
                                            FormTimePicker(
                                                readOnly: true,
                                                selectedDay: date,
                                                initialValue:
                                                    askedPoint.actualStartAt,
                                                labelText: AppLocalizations.of(
                                                        context)
                                                    .translate('actual_start'),
                                                icon: Icons.access_time),
                                            const SizedBox(height: 26),
                                            FormTimePicker(
                                                readOnly: true,
                                                selectedDay: date,
                                                initialValue:
                                                    askedPoint.actualEndAt,
                                                labelText: AppLocalizations.of(
                                                        context)
                                                    .translate('actual_end'),
                                                icon: Icons.access_time),
                                            const SizedBox(height: 26)
                                          ]
                                        : <Widget>[]) +
                                    <Widget>[
                                      OutlinedTextFormField(
                                          readOnly: true,
                                          initialValue:
                                              askedPoint.friendlyOrigin,
                                          labelText:
                                              AppLocalizations.of(context)
                                                  .translate('start_place'),
                                          icon: Icons.pin_drop),
                                      const SizedBox(height: 26),
                                      OutlinedTextFormField(
                                          readOnly: true,
                                          initialValue:
                                              askedPoint.friendlyDestiny,
                                          labelText:
                                              AppLocalizations.of(context)
                                                  .translate('end_place'),
                                          icon: Icons.flag),
