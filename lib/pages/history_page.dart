...
class _HistoryPageState extends State<HistoryPage> {
  ...
  StreamSubscription<QuerySnapshot> initAgentsListner() {
    return getIt<FirebaseFirestore>()
        ...
        .snapshots()
        .listen((QuerySnapshot agentsSnapshot) {
      setState(() {
  ...
  StreamSubscription<QuerySnapshot> initAskedPointsListener() {
    return getIt<FirebaseFirestore>()
        ...
        .where('email', isEqualTo: widget.email)
        .snapshots()
        .listen((QuerySnapshot askedPointsSnapshot) {
      setState(() {
        askedPoints =
  ...
  List<dynamic> getHistory() {
    ...
    history.sort((dynamic first, dynamic second) {
      ...
      final int secondTimeInt =
          secondTime is int ? secondTime : (secondTime as double).round();
