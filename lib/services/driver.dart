...
class DriverService {
  Future<dynamic> postNewAgent(String name, String garage, String friendlyGarage, int places, DateTime selectedStartDateTime, DateTime selectedEndDateTime, String email) async {
