  ...
  Future<void> _execute(int position) async {
    ...
    final Prediction prediction = await PlacesAutocomplete.show(
        ...
        hint: AppLocalizations.of(context)
            .translate(position == 0 ? 'search_start' : 'search_end'),
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
            TextField(
                ...
                decoration: InputDecoration(
                    ...
                    hintText:
                        AppLocalizations.of(context).translate('search_start')),
            ...
            AnimatedSize(
                ...
                child: Container(
                    child: showSecond || endControler.text != ''
                        ? TextField(
            ...
            Padding(
                ...
                child: TextButton(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Text(
                          showSecond || endControler.text != ''
                              ? AppLocalizations.of(context)
                                  .translate('hide_end')
                              : AppLocalizations.of(context)
                                  .translate('show_end'),
                          style: TextStyle(
                              color: endControler.text != ''
                                  ? Colors.grey
