...
class _MapListenerState extends State<MapListener> {
      ...
      if (routeCoords != null) {
        ...
        setState(() {
          ...
          polyline.removeWhere(
              (Polyline polyline) => polyline.polylineId == polylineId);
            ...
            Navigator.push(
                ...
                MaterialPageRoute<AskedPointPage>(
                    builder: (BuildContext context) => AskedPointPage(
                        askedPoint: askedPoint, readOnly: true, clear: () {})));
          },
  ...
  void initState() {
    super.initState();
    setState(() {
      agentIdsSubscription = getIt<FirebaseFirestore>()
          .collection('agent')
      ...
      watchAskedPointSubscription = getIt<FirebaseFirestore>()
          .collection('askedPoint')
          .where('email', isEqualTo: widget.email)
          .where('processed', isEqualTo: true)
          .where('actualEndAt',
      ...
      watchAgentsSubscription = getIt<FirebaseFirestore>()
          .collection('agent')
          .where('processed', isEqualTo: true)
          ...
          if (polyline.isNotEmpty) {
            ...
            setState(() {
              ...
              final Polyline newPolyline =
                  oldPolyline.copyWith(visibleParam: !oldPolyline.visible);
              ...
              hidePin = () {
                if (newPolyline.visible) {
                  ...
                  polyline.add(
                      newPolyline.copyWith(visibleParam: !newPolyline.visible));
                }
              };
            });
          }
  ...
  Future<void> _addAgentMarker(Agent agent) async {
    ...
    setState(() {
      widget.markers
          .removeWhere((Marker marker) => marker.markerId == _marker.markerId);
